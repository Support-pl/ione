 ...
 define(function (require) {
   ...
   function _retrieve(context) {
     ...
     console.log(1, TemplateUtils.stringToTemplate(templateJSON));
     return templateJSON;
   }
   ...
   function _submitWizard(context) {
     ...
     if (this.action == "create") {
       Sunstone.runAction(this.resource + ".create", {
         'vmtemplate': templateJSON
       });
       return false;
     } else if (this.action == "update") {
       console.log(2, templateJSON);
   ...
   function _submitAdvanced(context) {
     ...
     if (this.action == "create") {
       Sunstone.runAction(this.resource + ".create", {
         "vmtemplate": {
           "template_raw": templateStr
         }
       });
       return false;

     } else if (this.action == "update") {
       console.log(22, TemplateUtils.stringToTemplate(templateStr));
