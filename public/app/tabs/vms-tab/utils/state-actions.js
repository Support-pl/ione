...
define(function (require) {
  ...
  STATE_ACTIONS[OpenNebulaVM.STATES.INIT] = ["VM.resize", "VM.terminate_hard", "VM.recover"];

  STATE_ACTIONS[OpenNebulaVM.STATES.PENDING] = ["VM.hold", "VM.deploy", "VM.updateconf", "VM.terminate_hard", "VM.resize", "VM.reinstall", "VM.place_on_node", "VM.recover"];

  STATE_ACTIONS[OpenNebulaVM.STATES.HOLD] = ["VM.release", "VM.deploy", "VM.updateconf", "VM.terminate_hard", "VM.resize", "VM.reinstall", "VM.place_on_node", "VM.recover"];

  STATE_ACTIONS[OpenNebulaVM.STATES.ACTIVE] = [];

  STATE_ACTIONS[OpenNebulaVM.STATES.STOPPED] = ["VM.resume", "VM.deploy", "VM.terminate_hard", "VM.reinstall", "VM.recover"];

  STATE_ACTIONS[OpenNebulaVM.STATES.SUSPENDED] = ["VM.resume", "VM.disk_saveas", "VM.disk_snapshot_create", "VM.disk_snapshot_revert", "VM.disk_snapshot_delete", "VM.stop", "VM.terminate_hard", "VM.migrate", "VM.reinstall", "VM.recover"];

  STATE_ACTIONS[OpenNebulaVM.STATES.DONE] = ["VM.recover"];

  STATE_ACTIONS[OpenNebulaVM.STATES.FAILED] = ["VM.recover"];
  ...
  STATE_ACTIONS[OpenNebulaVM.STATES.UNDEPLOYED] = ["VM.resume", "VM.resize", "VM.deploy", "VM.updateconf", "VM.terminate_hard", "VM.recover"];

  STATE_ACTIONS[OpenNebulaVM.STATES.CLONING] = ["VM.updateconf", "VM.terminate_hard", "VM.resize", "VM.recover"];

  STATE_ACTIONS[OpenNebulaVM.STATES.CLONING_FAILURE] = ["VM.updateconf", "VM.terminate_hard", "VM.resize", "VM.recover"];
  ...
  LCM_STATE_ACTIONS[OpenNebulaVM.LCM_STATES.UNKNOWN] = ["VM.resched", "VM.unresched", "VM.poweroff", "VM.poweroff_hard", "VM.undeploy", "VM.undeploy_hard", "VM.migrate", "VM.migrate_live", "VM.resume", "VM.terminate", "VM.terminate_hard"];
