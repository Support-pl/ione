...
locale = {
    ...
    "50GB Disk Recovery takes approximately 1 hour.": "",
    "DAY": "",
    "WEEK": "",
    "MONTH": "",
    "COST / TIME indicator": "",
    ...
    "Cloud": "",
    "Cloud settings": "",
    "Select disk type disabled": "",
    "Reset": "",
    "Submit": "",
    "Changed hypervisor": "",
    "Sets VM State to HOLD": "",
    "Makes VM ready to be deployed(State PENDING)": "",
    "Stops VM, saves its state and deallocates resources from host(State STOPPED)": "",
    "Stops VM, saves its state and keeps resources on host(State SUSPENDED)": "",
    "Resumes VM from any state(State RUNNING)": "",
    "Reboots VM using guest OS": "",
    "Reboots VM using hardware reboot": "",
    "Turns VM off using guest OS(State POWEROFF)": "",
    "Turns VM off using hardware shutdown(State POWEROFF)": "",
    "Removes VM resources from host after turning it off(State PENDING)": "",
    "Removes VM resources from host(State PENDING)": "",
    "Creates Snapshot": "",
    "Deletes VM after turning it off(State DONE)": "",
    "Deletes VM immediately(State DONE)": "",
    "Balance": "",
